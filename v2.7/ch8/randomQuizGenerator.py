...
for quizNum in range(35): # Generate 35 quiz files.
    ...
    quizFile = open(os.path.join('quiz', 'capitalsquiz%s.txt' % (quizNum + 1)), 'w')
    answerKeyFile = open(os.path.join('quiz', 'capitalsquiz_answers%s.txt' % (quizNum + 1)), 'w')
    ...
    for questionNum in range(50):
        ...
        random.shuffle(answerOptions) # randomize the order of answers

        # Write out the questions and answer options.
